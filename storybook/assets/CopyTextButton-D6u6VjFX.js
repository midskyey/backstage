import{u as b,d as T}from"./useCopyToClipboard-CXmmh4yb.js";import{r as a,R as e}from"./index-CV65Cz2T.js";import{u as x,c as h}from"./translation-C5rFLNSv.js";import{T as y}from"./Tooltip-Dky-G2Xk.js";import{I as C}from"./IconButton-CiUvO6Eb.js";import{u as k}from"./ApiRef-CiiQxZ8_.js";import{e as w}from"./TranslationApi-CvQSfhLI.js";function g(r){const{t:i}=x(h),{text:s,tooltipDelay:l=1e3,tooltipText:p=i("copyTextButton.tooltipText"),"aria-label":c="Copy text"}=r,o=k(w),[u,n]=a.useState(!1),[{error:t},m]=b();a.useEffect(()=>{t&&o.post(t)},[t,o]);const f=d=>{d.stopPropagation(),n(!0),m(s)};return e.createElement(e.Fragment,null,e.createElement(y,{id:"copy-test-tooltip",title:p,placement:"top",leaveDelay:l,onClose:()=>n(!1),open:u},e.createElement(C,{onClick:f,"aria-label":c},e.createElement(T,null))))}g.__docgenInfo={description:`Copy text button with visual feedback
