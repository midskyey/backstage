import{j as r}from"./jsx-runtime-CvpxdxdE.js";import{G as p}from"./Gauge-CJ4ujEnz.js";import{m as v}from"./makeStyles-yUUo8jj4.js";import{B as y}from"./Box-CBL4LtOb.js";import{I as b}from"./InfoCard-DqxnFfGU.js";const q=v({root:{height:"100%",width:250},rootSmall:{height:"100%",width:160}},{name:"BackstageGaugeCard"});function f(n){const t=q(n),{title:i,subheader:a,progress:u,inverse:s,deepLink:o,description:g,icon:l,variant:d,alignGauge:m="normal",size:e="normal",getColor:c}=n,k={inverse:s,description:g,getColor:c,value:u};return r.jsx(y,{className:e==="small"?t.rootSmall:t.root,children:r.jsx(b,{title:i,subheader:a,deepLink:o,variant:d,alignContent:m,icon:l,titleTypographyProps:{...e==="small"?{variant:"subtitle2"}:void 0},subheaderTypographyProps:{...e==="small"?{variant:"body2"}:void 0},children:r.jsx(p,{...k,size:e})})})}f.__docgenInfo={description:`{@link Gauge} with header, subheader and footer
