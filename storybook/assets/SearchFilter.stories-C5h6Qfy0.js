import{r as M,R as t}from"./index-CTjT7uj6.js";import{s as de,M as pe}from"./api-CKDuuaL7.js";import{l as fe}from"./lodash-CoGan1YB.js";import{a as ge}from"./useAsync-CXA3qup_.js";import{u as ve}from"./useDebounce-4fqASXX_.js";import{u as N,S as ye}from"./SearchContext-BQYqBmky.js";import{A as be}from"./Autocomplete-OsGyWJRI.js";import{T as he}from"./TextField-D4lwjorG.js";import{C as we}from"./Chip-D1KLZ76I.js";import{m as ke}from"./makeStyles-Z1piKFaZ.js";import{a as oe,F as Se}from"./FormLabel-GBx5UJsV.js";import{F as qe}from"./FormControlLabel-B51HEFjO.js";import{C as Ae}from"./Checkbox-D6LSQhiX.js";import{S as De}from"./Select-CEQtTgPQ.js";import{S as $}from"./Grid-D0t_NOHX.js";import{P as w}from"./Paper-C4Wu2ZRy.js";import{T as Ee}from"./TestApiProvider-CoiMLMhd.js";import"./ApiRef-BSBwTmJJ.js";import"./useMountedState-DkESzBh4.js";import"./useAnalytics-DTrkS1Gy.js";import"./ConfigApi-DBUUc3nU.js";import"./defaultTheme-BrZMNV87.js";import"./clsx.m-CH7BE6MN.js";import"./Close-B4VUTeWM.js";import"./createSvgIcon-DvLPikTD.js";import"./capitalize-CPKBZ2U-.js";import"./withStyles-BoERxSk9.js";import"./hoist-non-react-statics.cjs-DzIEFHQI.js";import"./unstable_useId-B3Hiq1YI.js";import"./useControlled-CogIeAPD.js";import"./index-QA7F3UF1.js";import"./isMuiElement-Cb6QZSLO.js";import"./IconButton-DMMb49NM.js";import"./ButtonBase-g64HK8if.js";import"./TransitionGroupContext-BtzQ-Cv7.js";import"./Popper-B1XKQEe1.js";import"./Portal-DHXjgkAG.js";import"./ListSubheader-C5asPl49.js";import"./InputLabel-r4ugfFvA.js";import"./formControlState-ByiNFc8I.js";import"./useFormControl-F4cJWIkJ.js";import"./Select-BuWjpB6j.js";import"./react-is.production.min-D0tnNtx9.js";import"./useTheme-CxCkHA_V.js";import"./Popover-UDPOtf04.js";import"./Modal-D7Vu5nWs.js";import"./classCallCheck-BNzALLS0.js";import"./Grow-GUSO4DqQ.js";import"./utils-BJxIKHMK.js";import"./List-DOQrL9Id.js";import"./ListContext-DydK1sOh.js";import"./Typography-DhqftZOJ.js";import"./SwitchBase-Ce-v3etg.js";import"./createStyles-Bp4GwXob.js";import"./createStyles-yD3y8ldD.js";import"./Box-BuQ0oRjb.js";import"./typography-DfA0rp-6.js";import"./MenuItem-4a8da8Fj.js";import"./ListItem-Iyhdukvy.js";import"./ApiProvider-CuNQiN7Z.js";import"./index-BRV0Se7Z.js";const s=[];for(let e=0;e<256;++e)s.push((e+256).toString(16).slice(1));function Fe(e,n=0){return(s[e[n+0]]+s[e[n+1]]+s[e[n+2]]+s[e[n+3]]+"-"+s[e[n+4]]+s[e[n+5]]+"-"+s[e[n+6]]+s[e[n+7]]+"-"+s[e[n+8]]+s[e[n+9]]+"-"+s[e[n+10]]+s[e[n+11]]+s[e[n+12]]+s[e[n+13]]+s[e[n+14]]+s[e[n+15]]).toLowerCase()}let j;const Te=new Uint8Array(16);function Pe(){if(!j){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");j=crypto.getRandomValues.bind(crypto)}return j(Te)}const Ce=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),B={randomUUID:Ce};function Ie(e,n,l){var r;if(B.randomUUID&&!n&&!e)return B.randomUUID();e=e||{};const a=e.random??((r=e.rng)==null?void 0:r.call(e))??Pe();if(a.length<16)throw new Error("Random bytes length must be >= 16");return a[6]=a[6]&15|64,a[8]=a[8]&63|128,Fe(a)}const R=(e,n,l=[],a=250)=>{const r=M.useRef({}),o=e||(()=>Promise.resolve([])),[v,c]=ge(o,[n],{loading:!0});if(ve(()=>{r.current[n]===void 0&&(r.current[n]=c(n).then(m=>(r.current[n]=m,m)))},a,[c,n]),l.length)return{loading:!1,value:l};const p=r.current[n];return Array.isArray(p)?{loading:!1,value:p}:v},O=(e,n)=>{const{setFilters:l}=N();M.useEffect(()=>{n&&[n].flat().length>0&&l(a=>({...a,[e]:n}))},[])},ue=e=>{const{className:n,defaultValue:l,name:a,values:r,valuesDebounceMs:o,label:v,filterSelectedOptions:c,limitTags:p,multiple:m}=e,[k,y]=M.useState("");O(a,l);const S=typeof r=="function"?r:void 0,q=typeof r=="function"?void 0:r,{value:A,loading:u}=R(S,k,q,o),{filters:h,setFilters:d}=N(),D=h[a]||(m?[]:null),x=(f,g)=>{d(_=>{const{[a]:U,...W}=_;return g?{...W,[a]:g}:{...W}})},b=f=>t.createElement(he,{...f,name:"search",variant:"outlined",label:v,fullWidth:!0}),V=(f,g)=>f.map((_,U)=>t.createElement(we,{label:_,color:"primary",...g({index:U})}));return t.createElement(be,{filterSelectedOptions:c,limitTags:p,multiple:m,className:n,id:`${m?"multi-":""}select-filter-${a}--select`,options:A||[],loading:u,value:D,onChange:x,onInputChange:(f,g)=>y(g),renderInput:b,renderTags:V})};ue.__docgenInfo={description:"@public",methods:[],displayName:"AutocompleteFilter",props:{className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},values:{required:!1,tsType:{name:"union",raw:"string[] | ((partial: string) => Promise<string[]>)",elements:[{name:"Array",elements:[{name:"string"}],raw:"string[]"},{name:"unknown"}]},description:`Either an array of values directly, or an async function to return a list
