import{r as M,R as t}from"./index-CV65Cz2T.js";import{s as pe,M as de}from"./api-CnXCC1gD.js";import{l as fe}from"./lodash-D2SO6J9k.js";import{a as ge}from"./useAsync-cwiHyrW_.js";import{u as ve}from"./useDebounce-9bFRwIhD.js";import{u as N,S as ye}from"./SearchContext-CALk0UPB.js";import{A as be}from"./Autocomplete-BJpZXe13.js";import{T as he}from"./TextField-CwXF-gWd.js";import{C as we}from"./Chip-DktzKoNF.js";import{m as ke}from"./makeStyles-CkJZxfhX.js";import{a as oe,F as Se}from"./FormLabel-DHO9Aw1o.js";import{F as qe}from"./FormControlLabel-BObkJ45K.js";import{C as Ae}from"./Checkbox-C_O74NFt.js";import{S as De}from"./Select-D-qsBtZi.js";import{S as $}from"./Grid-DEL9PDyy.js";import{P as w}from"./Paper-Ra1TVF2W.js";import{T as Ee}from"./TestApiProvider-BLErwEGl.js";import"./ApiRef-CiiQxZ8_.js";import"./useMountedState-BG_s6PIB.js";import"./useAnalytics-BFZbt2Mh.js";import"./ConfigApi-cQMGuQTo.js";import"./defaultTheme-WHYcXxGo.js";import"./clsx.m-CH7BE6MN.js";import"./Close-BnaIPh3J.js";import"./createSvgIcon-BoOF83CO.js";import"./capitalize-52YtlJa-.js";import"./withStyles-C_eMWQcb.js";import"./hoist-non-react-statics.cjs-DscmM33_.js";import"./unstable_useId-DsWtIzNz.js";import"./useControlled-DPQJ7hKL.js";import"./debounce-DJZHKdQ4.js";import"./useIsFocusVisible-CkxE1YbK.js";import"./index-BBoiwMTC.js";import"./IconButton-shkqm6j7.js";import"./ButtonBase-DtZzUmL6.js";import"./TransitionGroupContext-C1n1zRT4.js";import"./Popper-BSfW9KPX.js";import"./Portal-W-tpMOzA.js";import"./ListSubheader-cs5TTGWx.js";import"./InputLabel-C1BQdAFz.js";import"./formControlState-ByiNFc8I.js";import"./useFormControl-Cf2zJBza.js";import"./Select-pXop2MzW.js";import"./react-is.production.min-D0tnNtx9.js";import"./useTheme-CyYT1vdA.js";import"./Popover-C3NuGn4W.js";import"./Modal-B_7UfOLo.js";import"./classCallCheck-BNzALLS0.js";import"./Grow-BlrHKxvL.js";import"./utils-DmolnGpv.js";import"./List-DulzYPgQ.js";import"./ListContext-DDd8B5Hf.js";import"./isMuiElement-DG475NJP.js";import"./Typography-DFGLiOLt.js";import"./SwitchBase-hlfF4IKz.js";import"./createStyles-Bp4GwXob.js";import"./createStyles-yD3y8ldD.js";import"./Box-Y2gNioDL.js";import"./typography-0XlFLCN0.js";import"./MenuItem-DBkobUt1.js";import"./ListItem-BzNdeZPd.js";import"./ApiProvider-B6zkipAU.js";import"./index-BDlCPcVq.js";const s=[];for(let e=0;e<256;++e)s.push((e+256).toString(16).slice(1));function Fe(e,n=0){return(s[e[n+0]]+s[e[n+1]]+s[e[n+2]]+s[e[n+3]]+"-"+s[e[n+4]]+s[e[n+5]]+"-"+s[e[n+6]]+s[e[n+7]]+"-"+s[e[n+8]]+s[e[n+9]]+"-"+s[e[n+10]]+s[e[n+11]]+s[e[n+12]]+s[e[n+13]]+s[e[n+14]]+s[e[n+15]]).toLowerCase()}let j;const Te=new Uint8Array(16);function Pe(){if(!j){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");j=crypto.getRandomValues.bind(crypto)}return j(Te)}const Ce=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),B={randomUUID:Ce};function Ie(e,n,l){var r;if(B.randomUUID&&!n&&!e)return B.randomUUID();e=e||{};const a=e.random??((r=e.rng)==null?void 0:r.call(e))??Pe();if(a.length<16)throw new Error("Random bytes length must be >= 16");return a[6]=a[6]&15|64,a[8]=a[8]&63|128,Fe(a)}const R=(e,n,l=[],a=250)=>{const r=M.useRef({}),o=e||(()=>Promise.resolve([])),[v,c]=ge(o,[n],{loading:!0});if(ve(()=>{r.current[n]===void 0&&(r.current[n]=c(n).then(m=>(r.current[n]=m,m)))},a,[c,n]),l.length)return{loading:!1,value:l};const d=r.current[n];return Array.isArray(d)?{loading:!1,value:d}:v},O=(e,n)=>{const{setFilters:l}=N();M.useEffect(()=>{n&&[n].flat().length>0&&l(a=>({...a,[e]:n}))},[])},ue=e=>{const{className:n,defaultValue:l,name:a,values:r,valuesDebounceMs:o,label:v,filterSelectedOptions:c,limitTags:d,multiple:m}=e,[k,y]=M.useState("");O(a,l);const S=typeof r=="function"?r:void 0,q=typeof r=="function"?void 0:r,{value:A,loading:u}=R(S,k,q,o),{filters:h,setFilters:p}=N(),D=h[a]||(m?[]:null),x=(f,g)=>{p(_=>{const{[a]:U,...W}=_;return g?{...W,[a]:g}:{...W}})},b=f=>t.createElement(he,{...f,name:"search",variant:"outlined",label:v,fullWidth:!0}),V=(f,g)=>f.map((_,U)=>t.createElement(we,{label:_,color:"primary",...g({index:U})}));return t.createElement(be,{filterSelectedOptions:c,limitTags:d,multiple:m,className:n,id:`${m?"multi-":""}select-filter-${a}--select`,options:A||[],loading:u,value:D,onChange:x,onInputChange:(f,g)=>y(g),renderInput:b,renderTags:V})};ue.__docgenInfo={description:"@public",methods:[],displayName:"AutocompleteFilter",props:{className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},values:{required:!1,tsType:{name:"union",raw:"string[] | ((partial: string) => Promise<string[]>)",elements:[{name:"Array",elements:[{name:"string"}],raw:"string[]"},{name:"unknown"}]},description:`Either an array of values directly, or an async function to return a list
