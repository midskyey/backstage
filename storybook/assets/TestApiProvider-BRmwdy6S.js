import{R as r}from"./index-CV65Cz2T.js";import{A as s}from"./ApiProvider-BkbfiZHS.js";class t{constructor(e){this.apis=e}static from(...e){return new t(new Map(e.map(([i,o])=>[i.id,o])))}get(e){return this.apis.get(e.id)}}const a=n=>r.createElement(s,{apis:t.from(...n.apis),children:n.children});a.__docgenInfo={description:`The \`TestApiProvider\` is a Utility API context provider that is particularly
