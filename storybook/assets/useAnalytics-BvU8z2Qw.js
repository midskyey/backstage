import{R as p,r as u}from"./index-CV65Cz2T.js";import{b as h,c as m,g as v,u as g}from"./ApiRef-DSSgzaW4.js";import{a as R}from"./ConfigApi-BmcvyZGI.js";const d=h("analytics-context"),l=()=>{const n=u.useContext(d);if(n===void 0)return{routeRef:"unknown",pluginId:"root",extension:"App"};const e=n.atVersion(1);if(e===void 0)throw new Error("No context found for version 1.");return e},f=n=>{const{attributes:e,children:r}=n,a={...l(),...e},s=R({1:a});return p.createElement(d.Provider,{value:s},r)};f.__docgenInfo={description:`Provides components in the child react tree an Analytics Context, ensuring
