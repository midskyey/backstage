import{p as d,s as h}from"./ref-8pKZtiZi.js";import{R as s}from"./index-CV65Cz2T.js";import{b as c,a as p}from"./ApiRef-CiiQxZ8_.js";import{a as u}from"./ConfigApi-cQMGuQTo.js";import{A as y}from"./useAnalytics-BFZbt2Mh.js";const T="parentOf",q="memberOf";function A(e,n,t){var r;let a=((r=e==null?void 0:e.relations)==null?void 0:r.filter(i=>i.type===n).map(i=>d(i.targetRef)))||[];return t!=null&&t.kind&&(a=a.filter(i=>i.kind.toLocaleLowerCase("en-US")===t.kind.toLocaleLowerCase("en-US"))),a}const f=c("entity-context"),o=e=>{const{children:n,entity:t,loading:a,error:r,refresh:i}=e,l={entity:t,loading:a,error:r,refresh:i};return s.createElement(f.Provider,{value:u({1:l})},s.createElement(y,{attributes:{...t?{entityRef:h(t)}:void 0}},n))},m=e=>s.createElement(o,{entity:e.entity,loading:!e.entity,error:void 0,refresh:void 0,children:e.children});function j(){const e=p("entity-context");if(!e)throw new Error("Entity context is not available");const n=e.atVersion(1);if(!n)throw new Error("EntityContext v1 not available");if(!n.entity)throw new Error("useEntity hook is being called outside of an EntityLayout where the entity has not been loaded. If this is intentional, please use useAsyncEntity instead.");return{entity:n.entity}}o.__docgenInfo={description:"Provides a loaded entity to be picked up by the `useEntity` hook.\n\n@public",methods:[],displayName:"AsyncEntityProvider",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},entity:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  /**
...
various ways.`},{key:"links",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
   ...
   */
  targetRef: string;
}`,signature:{properties:[{key:"type",value:{name:"string",required:!0},description:"The type of the relation."},{key:"targetRef",value:{name:"string",required:!0},description:"The entity ref of the target of this relation."}]}}],raw:"EntityRelation[]",required:!1},description:"The relations that this entity has with other entities."}]}},description:""},loading:{required:!0,tsType:{name:"boolean"},description:""},error:{required:!1,tsType:{name:"Error"},description:""},refresh:{required:!1,tsType:{name:"VoidFunction"},description:""}}};m.__docgenInfo={description:"Provides an entity to be picked up by the `useEntity` hook.\n\n@public",methods:[],displayName:"EntityProvider",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},entity:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  /**
   * The version of specification format for this particular entity that
   * this is written against.
   */
...
various ways.`},{key:"links",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
   ...
   */
  targetRef: string;
}`,signature:{properties:[{key:"type",value:{name:"string",required:!0},description:"The type of the relation."},{key:"targetRef",value:{name:"string",required:!0},description:"The entity ref of the target of this relation."}]}}],raw:"EntityRelation[]",required:!1},description:"The relations that this entity has with other entities."}]}},description:""}}};export{m as E,q as R,T as a,A as g,j as u};
